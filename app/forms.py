...
class CompanyForm(FlaskForm):
    ...
    wojewodztwa = SelectMultipleField('Województwa', coerce=str)
    powiaty = SelectMultipleField('Powiaty', coerce=int)
    
    # Specialties
    specjalnosci = SelectMultipleField('Specjalności', coerce=int)
